...
class UserCountTransformer(BaseEstimator, TransformerMixin):
    """
    Pipeline feature transformer to count user per hour
    ...
    def fit(self, X, y=None):
        ...
        # Group by and count unique user per hour
        data_group = {}
    ...
    def transform(self, X):
        re_array = np.array(self.user_count_feature).reshape(-1, 1)
        ...
        count_df["hourly_user_count"] = re_array
